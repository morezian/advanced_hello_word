...
# def start_srv(thread_name, delay, loop):
#     start_server = websockets.serve(WebSocketUtility.getInstance().notify_all, "localhost", 4000)
...
if __name__ == "__main__":
    ...
    #_thread.start_new_thread(start_srv, ("thr-1", 2, loop) )
